# Make sure to run this in top level directory: Autonomous-25-26
# Otherwise, imports will not work correctly, and you will get ModuleNotFoundError
    ...
    try:
        ...
        while cap.isOpened():
            ...
            if IS_ORIGINAL_FPS or time_elapsed > 1.0 / frame_rate:
                ...
                print("📐corner works")
                is_flipped = 1
                if IMU_ENABLED and imu_sensor.check_valid(1):
                    try:
