...
class RobotCornerDetection:
    ...
    def __init__(self, selected_colors: list, display_final_image: bool = False, display_possible_hueys: bool = False, frame_rate = 120):
        """
    ...
    def corner_detection_main(self, threshold_set=True) -> dict | None:
        """
