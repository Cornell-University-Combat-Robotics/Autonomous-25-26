...
# out = cv2.VideoWriter('fgbg_output.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 60, (1000,1000))
...
while cap.isOpened():
  ...
  cv2.imshow('frame', cv2.resize(cv2.bitwise_and(frame, frame, mask=fgmask), (1000, 1000)))
  # print(time.time()-t0)
