...
WINDOW_NAME = "Color Picking: Pick Huey color, color of the top T, then the color of the bottom T. Press 'z' to cancel previous selection. Once 3 colors are selected, press anywhere on the screen to continue"
...
if __name__ == "__main__":
    image_path = os.getcwd() + "/arrow/test/huey.png"
